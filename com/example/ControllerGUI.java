...
public class ControllerGUI {
        ...
        private final String diffLvl;
        private final ArrayList<String[]> answerSheets = new ArrayList<>();

        ArrayList<GridPane> gridPanes = new ArrayList<>();

        public ControllerGUI(int gridSize, int gridNumber, String difficultyLevel) {
                this.gameData = new GameData("com/example/GameData0001.txt");
                this.gridSize = gridSize;
                this.gridNumber = gridNumber;
                this.diffLvl = difficultyLevel;
                initializeUI();
        }
        ...
        private void positionLabeledGrid(Pane root, GridPane grid, int gridIndex) {
                String labelStyle = "-fx-border-color: black; -fx-border-width: 2; -fx-padding: 4 4 4 4; -fx-background-color: rgb(128,128,128); -fx-alignment: center;";
        ...
        private void initializeUI() {
                ...
                for (int i = 0; i < gridNumber; i++) {
                        ...
                        positionLabeledGrid(root, grid, i);
                        gridPanes.add(grid);
